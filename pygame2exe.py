...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "Move Them"

        #Project url
        self.project_url = "http://blog.lot-of-stuff.info/ludumdare/MoveThem"
        ...
        #Auhor of program
        self.author_name = "Remi Vanicat"
        self.author_email = "vanicat@debian.org"
        self.copyright = "Copyright (c) 2014, all right given."

        #Description
        self.project_description = "Move Them"
